<template>
  <div class="table">
    ...
    <el-table size="mini" border style="width:100%" height="800px" :data="data" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="歌曲图片" width="110" align="center">
        <template slot-scope="scope">
          ...
          <div class="play" @click="setSongUrl(scope.row.url,scope.row.name)">
            <div v-if="toggleName == (scope.row.name) && toggle == true">
                <svg class="icon">
                    <use xlink:href="#icon-zanting"></use>
                </svg>
            </div>
            <div v-show="toggleName != (scope.row.name) || toggle == false">
                <svg class="icon">
      ...
      <el-table-column label="专辑" prop="introduction" width="150" align="center">
      </el-table-column>
    ...
    <el-dialog title="修改歌曲" :visible.sync="editVisible" width="400px" center>
      <el-form :model="form" ref="form" label-width="80px">
        <el-form-item prop="name" label="歌名:" size="mini">
          <el-input v-model="form.name" placeholder="歌名" type="name"></el-input>
        </el-form-item>
        <el-form-item prop="introduction" label="专辑:" size="mini">
          <el-input v-model="form.introduction" placeholder="专辑" type="text"></el-input>
        </el-form-item>
...
export default {
  ...
  data(){
    return{
      singerId: '',           //歌手页转过来的歌手id
      singerName: '',         //歌手页转过来的歌手名字
  ...
  methods:{
    ...
    addSong(){
      ...
      req.onreadystatechange = function(){
        // req.readyStaet == 4 成功获取到返回的完整数据
        // req.status == 200 成功和后台完成交互
