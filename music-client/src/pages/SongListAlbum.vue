        ...
        <div class="album-content">
            ...
            <div class="album-score">
                ...
                <div>
                    ...
                    <div v-else>
                        <el-rate v-model="rank" disabled show-score text-color="#ff9900" ></el-rate>
                    </div>                 
                </div>
            </div>
...
import {listSongDetail,songOfSongId,setRank,getRankOfSongListId,getUserRank} from '../api/index';
...
export default {
    ...
    mounted(){
        // console.log("000="+this.userId);

      getUserRank(this.userId,this.songListId).then(res => {
        // console.log("000="+this.userId);
          if(res){
            this.rank = res/2;
