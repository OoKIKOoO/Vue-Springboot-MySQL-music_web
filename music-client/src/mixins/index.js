...
import {likeSongOfName,getCollectOfUserId,isadd,setPlayCount,addPlayCount} from '../api/index';
...
export const mixin = {
    ...
    methods: {
        ...
        attachImageUrl (srcUrl) {
            return srcUrl? this.$store.state.configure.HOST+srcUrl : this.$store.state.configure.HOST+'/img/songListPic/默认图片.jpg';
        },
        //根据歌手名字模糊查询歌曲
        getSong() {
        ...
        toplay: function(id,url,pic,index,name,lyric){
            ...
            this.$store.commit('setListPlayList',this.$store.state.song.listOfSongs);
