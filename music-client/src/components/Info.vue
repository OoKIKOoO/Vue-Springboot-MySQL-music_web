...
import {getUserOfId,updateUserMsg,updateComment} from '../api/index'
            ...
            updateUserMsg(params)
                .then(res => {
                    if(res.code == 1){
                        ...
                        // updateComment(this.userId,this.username,this.avator).then((res) => {
                        //   console.log("res::"+res);
                        // })
                        console.log("iiiiiiiii:"+this.userId,this.registerForm.username,this.avator);
