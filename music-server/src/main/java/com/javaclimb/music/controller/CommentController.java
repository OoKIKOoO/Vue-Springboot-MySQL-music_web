...
public class CommentController {
    ...
    public Object addComment(HttpServletRequest request){
        ...
        String userpic = request.getParameter("userpic").trim();
    ...
    public Object updateComment2(HttpServletRequest request){
        JSONObject jsonObject = new JSONObject();
        ...
        String content = request.getParameter("content").trim();         //评论内容
        String username = request.getParameter("username").trim();           //用户id
        String userpic = request.getParameter("userpic").trim();           //用户id
    ...
    public Object updateComment(HttpServletRequest request){
        JSONObject jsonObject = new JSONObject();
        String userId = request.getParameter("userId").trim();                   //主键
        String username = request.getParameter("username").trim();           //用户id
        String userpic = request.getParameter("userpic").trim();               //评论类型（0歌曲1歌单）
